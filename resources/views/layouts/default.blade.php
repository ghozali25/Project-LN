...
<head>
    ...
    <link rel="shortcut icon" type="image/ico"
          href="{{ ($snipeSettings) && ($snipeSettings->favicon!='') ?  Storage::disk('public')->url(e($snipeSettings->favicon)) : config('app.url').'/img/favicon.ico' }}">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree" {{ \App\Helpers\Helper::determineLanguageDirection() == 'rtl' ? 'style="margin-right:12px' : '' }}>
                        ...
                        @endcan
                            ...
                            <li class="{{ Request::is('dashboard-pbi') ? 'active' : '' }}">
                                <a href="{{ route('dashboard.pbi') }}">
                                    <i class="fa fa-bar-chart"></i> <span>Dashboard PBI</span>
                                </a>
                            </li>
                        ...
                        @endcan
                        @can('view', \App\Models\License::class)
                            <li  id="accessories-sidenav-option"{!! (Request::is('licenses*') ? ' class="active"' : '') !!}>
                            ...
                            <li id="settings-sidenav-option" class="treeview {!! in_array(Request::route()->getName(),App\Helpers\Helper::SettingUrls()) ? ' active': '' !!}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    @can('view', \App\Models\Depreciation::class)
                                        <li class="{{ Request::is('depreciations') ? 'active' : '' }}">
