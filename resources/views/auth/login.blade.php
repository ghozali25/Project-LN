    ...
    <form role="form" action="{{ url('/login') }}" method="POST" autocomplete="{{ (config('auth.login_autocomplete') === true) ? 'on' : 'off'  }}">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4" style="margin-left: 80%;"> {{-- default <div class="col-md-4 col-md-offset-4"> --}} 
                    ...
                    <div class="box login-box" style="background-color: rgba(255, 255, 255, 0.7); padding: 20px; border-radius: 10px;">
                        ...
                        <div class="login-box-body" style="background-color: rgba(255, 255, 255, 0.9); padding: 20px; border-radius: 10px;">
                            <div class="row">
