...
class ManufacturerSeeder extends Seeder
{
    public function run()
    {
        ...
        Manufacturer::factory()->count(1)->Honda()->create(['created_by' => $admin->id]);
        Manufacturer::factory()->count(1)->toyota()->create(['created_by' => $admin->id]);
        Manufacturer::factory()->count(1)->hyundai()->create(['created_by' => $admin->id]);
        Manufacturer::factory()->count(1)->nissan()->create(['created_by' => $admin->id]);
